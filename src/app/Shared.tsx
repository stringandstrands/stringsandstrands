        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 pb-10 border-b border-[#FFEAF2]/10">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              {[
                { label: "Instagram", icon: <Instagram size={14} />, url: "https://www.instagram.com/stringsandstrand/" },
                { label: "Facebook", icon: <Facebook size={14} />, url: "https://www.facebook.com/people/Strings-and-Strands/61584760435505/#" },
              ].map(s => (
                <a
                  key={s.label}
                  href={s.url}
